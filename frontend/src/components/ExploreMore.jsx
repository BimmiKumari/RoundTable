...
const ExploreMore = () => {
  ...
  return (
    <div style={{background: "linear-gradient(180deg, rgb(0, 0, 0) 10%, rgb(55, 94, 99) 50%);"}}>
      ...
      {/* Tabs Section */}
      <div className="hidden lg:flex gap-5 mt-0 mx-auto w-max bg-richblack-800 text-richblack-200 p-1 rounded-full font-medium drop-shadow-[0_1.5px_rgba(255,255,255,0.25)]">
      ...
      {/* Cards Group */}
      <div className="lg:absolute z-10 justify-center  flex gap-x-12 flex-wrap w-full  lg:left-[50%] ml-0 lg:translate-x-[-50%] lg:translate-y-[50%] text-black mt-0 lg:px-0 px-3">
